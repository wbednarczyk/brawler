...
Clicking a company row (or pressing Enter/Space on it) opens the **curated cockpit dashboard** scoped to that company ([ADR 0057](adr/0057-composable-views-and-curated-dashboard.md)). Up and Down arrows move the highlighted row within the library without navigating away.
