...
*Planned (vNEXT, ADR 0107):* the engine below serves ONLY the frozen named
views; the main company surface (`Spółka`) runs without a docking engine.
