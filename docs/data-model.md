...
The docking engine and its saved-layout table are retired ([ADR 0108](adr/0108-retire-docking-engine.md)); a forward migration drops the table (see the migrations directory).
