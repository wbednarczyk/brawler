...
- New storage refusals (`RunLeaseExpired`, takeover, budget) map through the wildcard-free `code_for` and join the mock-fidelity corpus with their tools (#384/#386).
