// The acquisition credential's frozen scope: exactly the nine KPI-ingest
// workflow tools, in contract order (ADR 0099 dec. 3; the Rust source of truth
// is `KPI_ACQUISITION_TOOLS` in `src-tauri/src/mcp/registry.rs`, frozen by the
