...
Open the company (Spółka screen) → **Open tool: Fundamentals**; the tool leads with **Price
context**:
...
Open the company (Spółka screen) → **Open tool: Ownership** → the **Basic info** panel shows the identity facts
