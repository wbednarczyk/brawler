...
Open the company (Spółka screen) → the **Fundamentals** workshop tool (or Ctrl+K → `Open tool: Fundamentals`); the tool leads with **Price
context**:
...
Open the company (Spółka screen) → the **Ownership** workshop tool (or Ctrl+K → `Open tool: Ownership`) → the **Basic info** panel shows the identity facts
