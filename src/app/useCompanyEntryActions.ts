 ...
 * ratchet, ADR 0103): opening a company lands the Spółka screen (F3a S1,
 * ADR 0107) — the ONE company deep-dive destination since the docking
 * engine's removal (ADR 0108).
 */
