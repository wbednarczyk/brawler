...
const PL_KPI_LABELS: Record<string, string> = {
  ...
  net_profit_discontinued: "Zysk netto (dział. zaniechana)",
  wdf_net_profit_parent: "Zysk netto (akcj. jedn. dominującej)",
  wdf_equity_parent: "Kapitał własny (akcj. jedn. dominującej)",
  inventories: "Zapasy",
...
const EN_KPI_LABELS: Record<string, string> = {
  ...
  net_profit_discontinued: "Net profit (discontinued ops)",
  wdf_net_profit_parent: "Net profit (parent shareholders)",
  wdf_equity_parent: "Equity (parent shareholders)",
