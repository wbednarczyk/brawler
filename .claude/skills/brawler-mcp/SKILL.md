...
| Claims | `create_management_claim`, `update_management_claim` | `"sourceEvidenceId":"<reportOrTranscriptId>","sourceEvidenceType":"report_document"` — valid types: `report_document` \| `feed_item` \| `manual` (a bare `"report"` is refused; caught live by the epic #285 T11 dogfooding ritual) |
