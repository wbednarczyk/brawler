...
fn reports_database_status() {
    ...
    // +1 internal brawler-red-flags (disabled) seeded by 0092 — owns the
    // synthetic feed items derived red flags raise (v0.57 T7, ADR 0083 D8).
    assert_eq!(status.source_adapters, 16);
