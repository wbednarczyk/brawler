//! The migration registry: one `Migration` entry per shipped `migrations/*.sql`
//! file, in append order. Extracted from `migrations.rs` (ADR 0103 file-size
//! ratchet — the runner/tests stay there; ADR 0108 S4 pulled this out ahead of
//! registering migration 0152).
