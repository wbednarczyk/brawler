...
/// Whether a concept namespace is the IFRS Foundation's own taxonomy — the
/// precondition for ANY crosswalk match (sol review finding 1, epic #398).
/// Every entry in this table names a STANDARD `ifrs-full` concept, so a
/// lookup keyed on the local name alone would silently canonicalize an
/// issuer extension that happens to reuse a standard local name (e.g. an
/// issuer-namespace `Revenue`), falsely aligning one company's bespoke
/// figure with every other company's standard one. Real namespaces observed
/// in the corpus: `https://xbrl.ifrs.org/taxonomy/<date>/ifrs-full` (and the
/// historical `http://` scheme); issuer extensions live under the issuer's
/// own domain (`http://www.xtb.com/xbrl/2025-12-31`).
pub fn is_standard_ifrs_namespace(namespace_uri: &str) -> bool {
    namespace_uri.starts_with("http://xbrl.ifrs.org/")
        || namespace_uri.starts_with("https://xbrl.ifrs.org/")
}

/// SQL predicate equivalent of [`is_standard_ifrs_namespace`], for the
/// harvest/coverage queries in `storage::report_tagged_facts` — one home for
/// the namespace rule, two dialects (ADR 0100 decision 2).
pub const STANDARD_IFRS_NAMESPACE_SQL_PREDICATE: &str =
    "(concept_namespace_uri LIKE 'http://xbrl.ifrs.org/%' OR concept_namespace_uri LIKE 'https://xbrl.ifrs.org/%')";
...
const ENTRIES: &[CrosswalkEntry] = &[
    ...
    CrosswalkEntry { concept: "AdjustmentsForGainLossOnDisposalOfInvestmentsInSubsidiariesJointVenturesAndAssociates", metric_key: "adj_disposal_gains_subsidiaries_joint_ventures_associates", label: "Adjustment — gain loss on disposal of investments in subsidiaries joint ventures and associates", value_kind: "monetary", statement_group: "cash_flow", period_nature: "duration" },
    ...
    CrosswalkEntry { concept: "AdjustmentsForImpairmentLossRecognisedInProfitOrLossGoodwill", metric_key: "adj_goodwill_impairment_in_profit_or_loss", label: "Adjustment — impairment loss recognised in profit or loss goodwill", value_kind: "monetary", statement_group: "cash_flow", period_nature: "duration" },
    CrosswalkEntry { concept: "AdjustmentsForImpairmentLossReversalOfImpairmentLossRecognisedInProfitOrLoss", metric_key: "adj_impairment_loss_reversal_in_profit_or_loss", label: "Adjustment — impairment loss reversal of impairment loss recognised in profit or loss", value_kind: "monetary", statement_group: "cash_flow", period_nature: "duration" },
    ...
    CrosswalkEntry { concept: "AdjustmentsToReconcileProfitLossOtherThanChangesInWorkingCapital", metric_key: "adj_to_reconcile_profit_loss_excl_working_capital", label: "Adjustments to reconcile profit loss excluding changes in working capital", value_kind: "monetary", statement_group: "cash_flow", period_nature: "duration" },
    ...
    CrosswalkEntry { concept: "CashFlowsFromUsedInOperations", metric_key: "cash_flows_from_operations", label: "Cash flows from operations", value_kind: "monetary", statement_group: "cash_flow", period_nature: "duration" },
    CrosswalkEntry { concept: "CashFlowsFromUsedInOperationsBeforeChangesInWorkingCapital", metric_key: "cash_flows_from_operations_before_working_capital_changes", label: "Cash flows from operations before changes in working capital", value_kind: "monetary", statement_group: "cash_flow", period_nature: "duration" },
    ...
    CrosswalkEntry { concept: "CashReceiptsFromRepaymentOfAdvancesAndLoansMadeToOtherPartiesClassifiedAsInvestingActivities", metric_key: "repayments_received_of_loans_made_to_other_parties", label: "Cash receipts from repayment of advances and loans made to other parties (investing)", value_kind: "monetary", statement_group: "cash_flow", period_nature: "duration" },
    CrosswalkEntry { concept: "CashReceiptsFromRepaymentOfAdvancesAndLoansMadeToRelatedParties", metric_key: "repayments_received_of_loans_made_to_related_parties", label: "Cash receipts from repayment of advances and loans made to related parties", value_kind: "monetary", statement_group: "cash_flow", period_nature: "duration" },
    ...
    CrosswalkEntry { concept: "ComprehensiveIncome", metric_key: "total_comprehensive_income", label: "Total comprehensive income", value_kind: "monetary", statement_group: "other", period_nature: "duration" },
    CrosswalkEntry { concept: "ComprehensiveIncomeAttributableToNoncontrollingInterests", metric_key: "comprehensive_income_attributable_nci", label: "Comprehensive income attributable to NCI", value_kind: "monetary", statement_group: "other", period_nature: "duration" },
    CrosswalkEntry { concept: "ComprehensiveIncomeAttributableToOwnersOfParent", metric_key: "comprehensive_income_attributable_parent", label: "Comprehensive income attributable to parent", value_kind: "monetary", statement_group: "other", period_nature: "duration" },
    ...
    CrosswalkEntry { concept: "CurrentAssetsOtherThanAssetsOrDisposalGroupsClassifiedAsHeldForSaleOrAsHeldForDistributionToOwners", metric_key: "current_assets_excl_held_for_sale_or_distribution", label: "Current assets excluding assets or disposal groups classified as held for sale or as held for distribution to owners", value_kind: "monetary", statement_group: "balance", period_nature: "instant" },
    ...
    CrosswalkEntry { concept: "CurrentPrepaymentsAndCurrentAccruedIncomeOtherThanCurrentContractAssets", metric_key: "current_prepayments_and_accrued_income_excl_contract_assets", label: "Current prepayments and current accrued income excluding current contract assets", value_kind: "monetary", statement_group: "balance", period_nature: "instant" },
    ...
    CrosswalkEntry { concept: "CurrentSecuredBankLoansReceivedAndCurrentPortionOfNoncurrentSecuredBankLoansReceived", metric_key: "current_secured_bank_loans_and_current_portion_of_noncurrent", label: "Current secured bank loans received and current portion of noncurrent secured bank loans received", value_kind: "monetary", statement_group: "balance", period_nature: "instant" },
    ...
    CrosswalkEntry { concept: "DividendsPaid", metric_key: "dividends_paid", label: "Dividends paid", value_kind: "monetary", statement_group: "cash_flow", period_nature: "duration" },
    ...
    CrosswalkEntry { concept: "GainsLossesOnCashFlowHedgesBeforeTax", metric_key: "gains_losses_on_cash_flow_hedges_before_tax", label: "Gains losses on cash flow hedges before tax", value_kind: "monetary", statement_group: "other", period_nature: "duration" },
    CrosswalkEntry { concept: "GainsLossesOnExchangeDifferencesOnTranslationNetOfTax", metric_key: "gains_losses_on_exchange_differences_on_translation_net_of_tax", label: "Gains losses on exchange differences on translation net of tax", value_kind: "monetary", statement_group: "other", period_nature: "duration" },
    CrosswalkEntry { concept: "GainsLossesOnExchangeDifferencesOnTranslationRecognisedInProfitOrLoss", metric_key: "fx_translation_gains_losses_in_profit_or_loss", label: "Gains losses on exchange differences on translation recognised in profit or loss", value_kind: "monetary", statement_group: "income", period_nature: "duration" },
    ...
    CrosswalkEntry { concept: "ImpairmentLossReversalOfImpairmentLossRecognisedInProfitOrLoss", metric_key: "impairment_loss_reversal_in_profit_or_loss", label: "Impairment loss reversal of impairment loss recognised in profit or loss", value_kind: "monetary", statement_group: "income", period_nature: "duration" },
    ...
    CrosswalkEntry { concept: "IncomeTaxRelatingToCashFlowHedgesOfOtherComprehensiveIncome", metric_key: "income_tax_relating_to_cash_flow_hedges_of_oci", label: "Income tax relating to cash flow hedges of OCI", value_kind: "monetary", statement_group: "other", period_nature: "duration" },
    CrosswalkEntry { concept: "IncomeTaxRelatingToComponentsOfOtherComprehensiveIncomeThatWillBeReclassifiedToProfitOrLoss", metric_key: "income_tax_relating_to_components_of_oci_reclassifiable", label: "Income tax relating to components of OCI (reclassifiable)", value_kind: "monetary", statement_group: "other", period_nature: "duration" },
    CrosswalkEntry { concept: "IncomeTaxRelatingToComponentsOfOtherComprehensiveIncomeThatWillNotBeReclassifiedToProfitOrLoss", metric_key: "income_tax_relating_to_components_of_oci_non_reclassifiable", label: "Income tax relating to components of OCI (non-reclassifiable)", value_kind: "monetary", statement_group: "other", period_nature: "duration" },
    CrosswalkEntry { concept: "IncomeTaxRelatingToRemeasurementsOfDefinedBenefitPlansOfOtherComprehensiveIncome", metric_key: "income_tax_oci_remeasurement_defined_benefit_plans", label: "Income tax on OCI — defined benefit plan remeasurements", value_kind: "monetary", statement_group: "other", period_nature: "duration" },
    ...
    CrosswalkEntry { concept: "InvestmentsInSubsidiariesJointVenturesAndAssociates", metric_key: "investments_in_subsidiaries_joint_ventures_associates", label: "Investments in subsidiaries joint ventures and associates", value_kind: "monetary", statement_group: "balance", period_nature: "instant" },
    ...
    CrosswalkEntry { concept: "NoncurrentAccrualsAndNoncurrentDeferredIncomeIncludingNoncurrentContractLiabilities", metric_key: "noncurrent_accruals_and_deferred_income_incl_contracts", label: "Noncurrent accruals and noncurrent deferred income including noncurrent contract liabilities", value_kind: "monetary", statement_group: "balance", period_nature: "instant" },
    ...
    CrosswalkEntry { concept: "NoncurrentAssetsOrDisposalGroupsClassifiedAsHeldForSaleOrAsHeldForDistributionToOwners", metric_key: "noncurrent_assets_held_for_sale_or_distribution", label: "Non-current assets held for sale or for distribution to owners", value_kind: "monetary", statement_group: "balance", period_nature: "instant" },
    ...
    CrosswalkEntry { concept: "NoncurrentPrepaymentsAndNoncurrentAccruedIncomeOtherThanNoncurrentContractAssets", metric_key: "noncurrent_prepayments_accrued_income_excl_contract_assets", label: "Noncurrent prepayments and noncurrent accrued income excluding noncurrent contract assets", value_kind: "monetary", statement_group: "balance", period_nature: "instant" },
    ...
    CrosswalkEntry { concept: "OtherAdjustmentsForNoncashItems", metric_key: "other_adj_noncash_items", label: "Adjustment — other non-cash items", value_kind: "monetary", statement_group: "cash_flow", period_nature: "duration" },
    ...
    CrosswalkEntry { concept: "OtherComprehensiveIncome", metric_key: "other_comprehensive_income", label: "Other comprehensive income", value_kind: "monetary", statement_group: "other", period_nature: "duration" },
    CrosswalkEntry { concept: "OtherComprehensiveIncomeBeforeTax", metric_key: "oci_before_tax", label: "OCI before tax", value_kind: "monetary", statement_group: "other", period_nature: "duration" },
    CrosswalkEntry { concept: "OtherComprehensiveIncomeBeforeTaxCashFlowHedges", metric_key: "oci_before_tax_cash_flow_hedges", label: "OCI before tax cash flow hedges", value_kind: "monetary", statement_group: "other", period_nature: "duration" },
    CrosswalkEntry { concept: "OtherComprehensiveIncomeBeforeTaxExchangeDifferencesOnTranslation", metric_key: "oci_before_tax_exchange_differences_on_translation", label: "OCI before tax exchange differences on translation", value_kind: "monetary", statement_group: "other", period_nature: "duration" },
    CrosswalkEntry { concept: "OtherComprehensiveIncomeBeforeTaxGainsLossesFromInvestmentsInEquityInstruments", metric_key: "oci_before_tax_gains_losses_equity_investments", label: "OCI before tax gains losses from investments in equity instruments", value_kind: "monetary", statement_group: "other", period_nature: "duration" },
    CrosswalkEntry { concept: "OtherComprehensiveIncomeBeforeTaxGainsLossesOnRemeasurementsOfDefinedBenefitPlans", metric_key: "oci_remeasurement_defined_benefit_plans_before_tax", label: "OCI — defined benefit plan remeasurements (before tax)", value_kind: "monetary", statement_group: "other", period_nature: "duration" },
    CrosswalkEntry { concept: "OtherComprehensiveIncomeNetOfTaxCashFlowHedges", metric_key: "oci_net_of_tax_cash_flow_hedges", label: "OCI net of tax cash flow hedges", value_kind: "monetary", statement_group: "other", period_nature: "duration" },
    CrosswalkEntry { concept: "OtherComprehensiveIncomeNetOfTaxExchangeDifferencesOnTranslation", metric_key: "oci_fx_translation_net_of_tax", label: "OCI — FX translation (net of tax)", value_kind: "monetary", statement_group: "other", period_nature: "duration" },
    CrosswalkEntry { concept: "OtherComprehensiveIncomeNetOfTaxGainsLossesFromInvestmentsInEquityInstruments", metric_key: "oci_net_of_tax_gains_losses_equity_investments", label: "OCI net of tax gains losses from investments in equity instruments", value_kind: "monetary", statement_group: "other", period_nature: "duration" },
    CrosswalkEntry { concept: "OtherComprehensiveIncomeNetOfTaxGainsLossesOnRemeasurementsOfDefinedBenefitPlans", metric_key: "oci_net_of_tax_gains_losses_defined_benefit_remeasurement", label: "OCI net of tax gains losses on remeasurements of defined benefit plans", value_kind: "monetary", statement_group: "other", period_nature: "duration" },
    CrosswalkEntry { concept: "OtherComprehensiveIncomeNetOfTaxGainsLossesOnRevaluation", metric_key: "oci_net_of_tax_gains_losses_on_revaluation", label: "OCI net of tax gains losses on revaluation", value_kind: "monetary", statement_group: "other", period_nature: "duration" },
    CrosswalkEntry { concept: "OtherComprehensiveIncomeThatWillBeReclassifiedToProfitOrLossBeforeTax", metric_key: "oci_reclassifiable_before_tax", label: "OCI (reclassifiable) before tax", value_kind: "monetary", statement_group: "other", period_nature: "duration" },
    CrosswalkEntry { concept: "OtherComprehensiveIncomeThatWillBeReclassifiedToProfitOrLossNetOfTax", metric_key: "oci_reclassifiable_net_of_tax", label: "OCI reclassifiable to profit or loss (net of tax)", value_kind: "monetary", statement_group: "other", period_nature: "duration" },
    CrosswalkEntry { concept: "OtherComprehensiveIncomeThatWillNotBeReclassifiedToProfitOrLossBeforeTax", metric_key: "oci_non_reclassifiable_before_tax", label: "OCI (non-reclassifiable) before tax", value_kind: "monetary", statement_group: "other", period_nature: "duration" },
    CrosswalkEntry { concept: "OtherComprehensiveIncomeThatWillNotBeReclassifiedToProfitOrLossNetOfTax", metric_key: "oci_non_reclassifiable_net_of_tax", label: "OCI not reclassifiable to profit or loss (net of tax)", value_kind: "monetary", statement_group: "other", period_nature: "duration" },
    ...
    CrosswalkEntry { concept: "OtherLongtermProvisions", metric_key: "other_long_term_provisions", label: "Other longterm provisions", value_kind: "monetary", statement_group: "balance", period_nature: "instant" },
    ...
    CrosswalkEntry { concept: "ProceedsFromIssuingShares", metric_key: "proceeds_from_issuing_shares", label: "Proceeds from issuing shares", value_kind: "monetary", statement_group: "cash_flow", period_nature: "duration" },
    ...
    CrosswalkEntry { concept: "ProceedsFromSalesOrMaturityOfFinancialInstrumentsClassifiedAsInvestingActivities", metric_key: "proceeds_from_sales_or_maturity_of_financial_instruments", label: "Proceeds from sales or maturity of financial instruments (investing)", value_kind: "monetary", statement_group: "cash_flow", period_nature: "duration" },
    ...
    CrosswalkEntry { concept: "PurchaseOfFinancialInstrumentsClassifiedAsInvestingActivities", metric_key: "purchase_of_financial_instruments_investing", label: "Purchase of financial instruments (investing)", value_kind: "monetary", statement_group: "cash_flow", period_nature: "duration" },
    ...
    CrosswalkEntry { concept: "RightofuseAssetsThatDoNotMeetDefinitionOfInvestmentProperty", metric_key: "right_of_use_assets_not_investment_property", label: "Rightofuse assets that do not meet definition of investment property", value_kind: "monetary", statement_group: "balance", period_nature: "instant" },
    CrosswalkEntry { concept: "SaleOrIssueOfTreasuryShares", metric_key: "sale_or_issue_of_treasury_shares", label: "Sale or issue of treasury shares", value_kind: "monetary", statement_group: "other", period_nature: "duration" },
    ...
    CrosswalkEntry { concept: "ShorttermBorrowings", metric_key: "short_term_borrowings", label: "Shortterm borrowings", value_kind: "monetary", statement_group: "balance", period_nature: "instant" },
...
mod tests {
    ...
    #[test]
    fn the_curated_vocabulary_never_shrinks_below_the_corpus_harvest_floor() {
        // Guardrail against the table shrinking silently. The floor is the
        // CURRENT size after the corpus-wide harvest (84 instance-bearing
        // packages, >=3-issuer standard concepts) — a stale lower floor let
        // an entire seed batch vanish while staying green (sol review
        // finding 11). Raising this number is part of adding entries;
        // lowering it is a deliberate, reviewed vocabulary retirement.
        assert!(
            entries().len() >= 327,
            "expected at least 327 crosswalk entries, got {}",
            entries().len()
        );
    }
}
