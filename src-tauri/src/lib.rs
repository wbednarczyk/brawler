...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::pipeline_reextraction::run_pipeline_reextraction,
            commands::pipeline_reextraction::get_pipeline_reextraction_progress,
            ...
            commands::mcp::regenerate_kpi_acquisition_token,
            commands::mcp::revoke_kpi_acquisition_token,
            commands::mcp::kpi_acquisition_token_status,
...
mod tests {
    ...
    fn health_reports_ok() {
        ...
        assert_eq!(response.version, "0.75.0");
    }
