...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::quality_frameworks::run_qualitative_assessment,
            commands::quality_frameworks::rerun_qualitative_criterion,
            commands::quality_frameworks::get_qualitative_assessment,
            commands::quality_frameworks::get_qualitative_assessment_status,
...
mod tests {
    ...
    fn health_reports_ok() {
        ...
        assert_eq!(response.version, "0.52.0");
    }
