...
pub fn get_log_status(
    ...
    logging::log_status(app_data_dir, &resolved).map_err(|error| error.to_string())
}
...
pub fn list_log_entries(
    ...
    logging::read_log_entries(app_data_dir, resolved.max_files, limit)
        .map_err(|error| error.to_string())
}
...
pub fn open_logs_directory(
    ...
    let app_data_dir = app
        ...
        .app_data_dir()
        .map_err(|error| error.to_string())?;
    let logs_dir = logging::logs_dir(app_data_dir);
